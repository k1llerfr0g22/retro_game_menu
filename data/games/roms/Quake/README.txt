 ...
 * The new package includes DOSBox 0.74-3
 * Default SDL output is now "overlay"
 * The game is launched with the .BAT file you can find in the
   main dir
 * All packages now use the same template
...
-----------------------------------------------------------------
 ...
 --------------------
 GamesNostalgia DOS Windows package version 1.1a - May 2020
